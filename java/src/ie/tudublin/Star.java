...
public class Star
{
    ...
    public void render(StarMap pa)
    {
        ...
        pa.line(x, y -5, x, y + 5);
        pa.line(x-5, y, x + 5, y);
        pa.stroke(255, 0, 0);//circle
        pa.noFill();
        pa.circle(x, y, absMag);//at poition x and y, radius is absMag
        pa.fill(255);
        pa.textSize(16);
        pa.textAlign(PApplet.LEFT, PApplet.CENTER);//papplet i name of class left is x and center is y
